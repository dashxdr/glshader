...
// also see another implementation here -> http://glsl.heroku.com/e#207.5
...
void main( void ) 
{
	...
	if(fCellState > 0.5)
	{
		if((fNeighbourCount > 1.9) && (fNeighbourCount < 3.1))
		{
			fAlive = 1.0;
		}
	}
	...
	vec3 vResult = mix( vBack, vec3(0.0, 1.0, 0.0), fAlive );
